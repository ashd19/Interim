...
const Buttons = ({ title, onClick, redirectUrl }) => {
  const content = (
    <div className="flex gap-1 items-center group w-fit group-hover:gap-0" onClick={onClick}>
      ...
      <div className="p-2 w-[50px] h-[50px] bg-[#f3ad84] rounded-xl flex items-center mb-0.5 justify-center group-hover:-ml-0.5 transition-all duration-300 ease-in group-hover:rounded-bl-none">
